...
public class XlsReader {
  ...
  // find whether sheets exists	
	...
	public void compareExcelFile(String upldPath, String dwnldPath)
	{
            try {
				FileInputStream excellFile1 = new FileInputStream(new File(upldPath));
				FileInputStream excellFile2 = new FileInputStream(new File(dwnldPath));
